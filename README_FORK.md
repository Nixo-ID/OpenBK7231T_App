...
Lab notes, commissioning scripts, and HA drafts live in the project repo **[Cloudcutter.Lumary8](https://github.com/Nixo-ID/Cloudcutter.Lumary8)** (not in this tree).
